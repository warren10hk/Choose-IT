...
for counter, i in enumerate(data):
    ...
    try:
        temp["fields"]["Ram"] = ', '.join(map(str, i["specification"]["RAM"]))
    except TypeError:
        temp["fields"]["Ram"] = i["specification"]["RAM"]
    
    try:
        temp["fields"]["Rom"] = ', '.join(map(str, i["specification"]["ROM"]))
    except TypeError:
        temp["fields"]["Rom"] = i["specification"]["ROM"]

    try:
        temp["fields"]["Usb"] = i["connectivity"]["USB"]
    except:
        pass
